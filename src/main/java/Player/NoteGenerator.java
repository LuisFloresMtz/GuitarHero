    ...
    public void run() {
        ...
        while (true) {
            ...
            synchronized (notes) {
                ...
                switch ((int) aux) {
                    case 1:
                        notes.add(new GameNote(xpos, 0, new Color(8, 200, 3)));
                        break;
                    case 2:
                        notes.add(new GameNote(xpos + 75, 0, new Color(163, 24, 24)));
                        break;
                    case 3:
                        notes.add(new GameNote(xpos + 150, 0, new Color(254, 254, 53)));
                        break;
                    case 4:
                        notes.add(new GameNote(xpos + 225, 0, new Color(63, 162, 211)));
                        break;
                    case 5:
                        notes.add(new GameNote(xpos + 300, 0, new Color(217, 147, 53)));
                        break;
                }
            }
        }
